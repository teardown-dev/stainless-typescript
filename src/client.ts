...
export interface ClientOptions {
  /**
   * Defaults to process.env['TEARDOWN_API_KEY'].
   */
   ...
   *
   * Defaults to process.env['TEARDOWN_BASE_URL'].
   */
   ...
   * Set the log level.
   *
   * Defaults to process.env['TEARDOWN_LOG'] or 'warn' if it isn't set.
   */
...
export class Teardown {
   ...
   */
  constructor({
    baseURL = readEnv('TEARDOWN_BASE_URL'),
    apiKey = readEnv('TEARDOWN_API_KEY') ?? null,
    ...opts
  }: ClientOptions = {}) {
    ...
    this.timeout = options.timeout ?? Teardown.DEFAULT_TIMEOUT /* 1 minute */;
    ...
    this.logLevel =
      ...
      parseLogLevel(readEnv('TEARDOWN_LOG'), "process.env['TEARDOWN_LOG']", this) ??
      defaultLogLevel;
  ...
  static Teardown = this;
  static DEFAULT_TIMEOUT = 60000; // 1 minute

  static TeardownError = Errors.TeardownError;
